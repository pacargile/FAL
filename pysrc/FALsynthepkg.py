...
class synthe(object):
    def __init__(self,ID=None,verbose=True,clobber=False,starpars=None):
        ...
        self._fastcopy(self.datadir+'/FAL/inputfiles/molecules.dat','/dev/shm/FAL/{0}/molecules.dat'.format(self.ID))
        ...
        try:
            ...
            pass
        # BOB's CONTINUA FILE
        self._fastcopy(self.datadir+'/FAL/inputfiles/continua.dat','/dev/shm/FAL/{0}/continua.dat'.format(self.ID))
        ...
        try:
            ...
            pass
        self._fastcopy(self.datadir+'/FAL/inputfiles/he1tables.dat','/dev/shm/FAL/{0}/he1tables.dat'.format(self.ID))
        ...
        try:
            ...
            pass
        self._fastcopy(self.datadir+'/FAL/inputfiles/spectrv.input','/dev/shm/FAL/{0}/spectrv.input'.format(self.ID))
