...
subroutine readoutspecbin(&
  ...
  character(kind=c_char,len=15),   intent(out) :: LABELin(NLINESi)
  real(c_double), intent(out) :: EPin(NLINESi)
  real(c_double), intent(out) :: XJPin(NLINESi)
  character(kind=c_char,len=15),   intent(out) :: LABELPin(NLINESi)
  ...
  character(kind=c_char,len=15),   intent(out) :: REFin(NLINESi)
  ...
  character(kind=c_char,len=15),   intent(out) :: OTHER1in(NLINESi)
  character(kind=c_char,len=15),   intent(out) :: OTHER2in(NLINESi)
