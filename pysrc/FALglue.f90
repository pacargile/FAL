...
subroutine readoutspecbin(&
  ...
  real(c_char),   intent(out) :: LABELin(NLINESi)
  real(c_double), intent(out) :: EPin(NLINESi)
  real(c_double), intent(out) :: XJPin(NLINESi)
  real(c_char),   intent(out) :: LABELPin(NLINESi)
  ...
  real(c_char),   intent(out) :: REFin(NLINESi)
  real(c_int),    intent(out) :: NBLOin(NLINESi)
  real(c_int),    intent(out) :: NBUPin(NLINESi)
  real(c_int),    intent(out) :: ISO1in(NLINESi)
