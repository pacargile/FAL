...
subroutine readoutspecbin(&
  ...
  character(c_char,len=10),   intent(out) :: LABELin(NLINESi)
  real(c_double), intent(out) :: EPin(NLINESi)
  real(c_double), intent(out) :: XJPin(NLINESi)
  character(c_char,len=10),   intent(out) :: LABELPin(NLINESi)
  ...
  character(c_char,len=10),   intent(out) :: REFin(NLINESi)
  ...
  character(c_char,len=10),   intent(out) :: OTHER1in(NLINESi)
  character(c_char,len=10),   intent(out) :: OTHER2in(NLINESi)
  ...
  REAL*4 ALINEC, NELION
  character LABEL,LABELP,REF
