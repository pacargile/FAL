...
C     GS=-16.383
   ...
   20 CONTINUE
   21 N=N-1
      WRITE(6,*)'LAST LINE READ IN:'
      WRITE(6,*)N
      WRITE(6,*)'LAST WL READ IN:'
      WRITE(6,*)WLVAC
      WRITE(6,*)'TOTAL LINES ON TAPE 12:'
      WRITE(6,*)NLINES
      WRITE(6,*)'TOTAL LINES ADDED FROM TAPE 12:'
      WRITE(6,*)N
      WRITE(6,*)'TOTAL LINES ADDED FROM TAPE 14:'
      WRITE(6,*)N14
C
      OPEN(UNIT=93,FILE="fort.93",STATUS='OLD',
     $     FORM='UNFORMATTED',POSITION='REWIND')
