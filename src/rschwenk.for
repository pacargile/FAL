...
C     GS=-16.383
   ...
   21 N=N-1
      print *,n14
      WRITE(6,22)N
   22 FORMAT(I10,25H IS LAST LINE)
      WRITE(6,19)WLVAC
   25 WRITE(6,26)NLINES
   26 FORMAT(I10,25H TOTAL LINES ON TAPE 12)
   27 WRITE(6,28)N
   28 FORMAT(I10,25H LINES ADDED ON TAPE 12)
   29 WRITE(6,30)N14
   30 FORMAT(I10,25H LINES ADDED ON TAPE 14)
C
      OPEN(UNIT=93,FILE="fort.93",STATUS='OLD',
     $     FORM='UNFORMATTED',POSITION='REWIND')
