...
C      REAL*8 ASYNTH,ALINEC,TITLE,TEFF,GLOG,IDMOL,MOMASS
      ...
      OPEN(UNIT=2,file='fort.2',STATUS='NEW',FORM='UNFORMATTED')
      OPEN(UNIT=3,file='fort.3',STATUS='NEW',FORM='UNFORMATTED')
      OPEN(UNIT=4,file='fort.4',STATUS='NEW',FORM='UNFORMATTED')
...
C           DO THE CORRECTION
            ...
            print *, I, GFLOG, GFLOGI, CONGF, CODE, ISO1, ISO2
          ENDIF
