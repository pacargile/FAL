...
C      REAL*8 ASYNTH,ALINEC,TITLE,TEFF,GLOG,IDMOL,MOMASS
      ...
      real*8 wavel
      REAL*8 ISOFRAC, ISOFRACISO1, ISOFRACISO2, GFLOGI
...
C           DO THE CORRECTION
            ...
            IF(ISO1.EQ.ISOFRACISO1)THEN
              GFLOGI = GFLOGI+0.005-LOG10(1.0+(1.0/ISOFRAC))
            ENDIF
            IF(ISO1.EQ.ISOFRACISO2)THEN
              GFLOGI = GFLOGI+1.955-LOG10(1.0+ISOFRAC)
            ENDIF
            GF = 10.0**(GFLOGI)

          ENDIF
 3440     WRITE(1)WL,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,
     1      GAMMAR,GAMMAS,GAMMAW,NBUFF
C  3440     WRITE(2)LINDAT8,LINDAT4
        ENDIF
...
C           DO THE CORRECTION
            ...
            print *, I, GFLOGI, CONGF, CODE, ISO1, ISO2
            ...
            print *, I, GFLOGI, CONGF, CODE, ISO1, ISO2
          ENDIF
 3441     WRITE(3)NBUFF,CONGF,NELION,ELO,GAMRF,GAMSF,GAMWF
C  3441     WRITE(4)LINDAT8,LINDAT4
        ENDIF
 3442 CLOSE(UNIT=19)
      CLOSE(UNIT=20)
      CLOSE(UNIT=12)
