...
C     TAPE93 parameters for this run from SYNBEG
      ...
      PARAMETER (LENREC=10000000,MAXLEN=1000000001,MAXPROF=10000000,
...
C      OPEN(UNIT=20,STATUS='OLD',FORM='UNFORMATTED',ACCESS='APPEND')
      ...
      IF(N19.GT.0)THEN
C      REWIND 20
C      WRITE(6,*) 'LINES WRITTEN TO FORT.20:'
...
C       WRITE(6,666)WL,DWL,GFLOG,DGFLOG,CODE,E,XJ,LABEL,
C     1 EP,XJP,LABELP,GR,DGAMMAR,GS,DGAMMAS,GW,DGAMMAW,WAVENO,
C     2 REF,NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,ISOSHIFT,NELION
 3440 WRITE(13)LINDAT8,LINDAT4
      ENDIF
      IF(NLINES.GT.0)THEN
      REWIND 99
C      WRITE(6,*) 'LINES WRITTEN TO FORT.14:'
      DO 3441 I=1,NLINES
      READ(99)LINDAT8,LINDAT4
C      WRITE(6,666)WL,DWL,GFLOG,DGFLOG,CODE,E,XJ,LABEL,
C     1EP,XJP,LABELP,GR,DGAMMAR,GS,DGAMMAS,GW,DGAMMAW,WAVENO,
C     2REF,NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,ISOSHIFT,NELION
