...
C      1           MAXBUFF=MAXLEN+MAXPROF*2,MAXLIN=MAXBUFF+MAXPROF*4)
...
C      OPEN(UNIT=20,STATUS='OLD',FORM='UNFORMATTED',ACCESS='APPEND')
      ...
      IF(N19.GT.0)THEN
      REWIND 20
      WRITE(6,*) 'LINES READ FROM FORT.20:'
...
C     PRINT LINES THAT WERE WRITTEN TO FORT.20
 ...
 3440 WRITE(13)LINDAT8,LINDAT4
      ...
      IF(NLINES.GT.0)THEN
      REWIND 99
      WRITE(6,*) 'LINES READ FROM FORT.99:'
      DO 3441 I=1,NLINES
...
C       IF(J.EQ.1)THEN
C         IF(ILINE.GT.(NLINES-100))THEN
C           IF(KAPPA0.LT.KAPMIN)THEN
C             WRITE(6,*)'KAPPA0 < KAPMIN',NBUFF,KAPMIN,CUTOFF
C           ENDIF
C         ENDIF
C       ENDIF
      IF(KAPPA0.LT.KAPMIN)GO TO 350
C       IF(KAPPA0.LT.KAPMIN)THEN
C         WRITE(6,*)'SKIPPING LINE CASE 1'
C         WRITE(6,*)ILINE
C         WRITE(6,*)KAPMIN
C         WRITE(6,*)KAPPA0
C         GO TO 350
...
C     KAPPA0=KAPPA0*EXP(-ELO*HCKT(J))
      IF(KAPPA0.LT.KAPMIN)GO TO 350
C       IF(KAPPA0.LT.KAPMIN)THEN
C         WRITE(6,*)'SKIPPING LINE CASE 2'
C         WRITE(6,*)ILINE
C         WRITE(6,*)KAPMIN
C         WRITE(6,*)KAPPA0
C         GO TO 350
...
C       HH1=H1TAB(IV)+H0TAB(IV)*1.12838D0
C       HH2=H2TAB(IV)+HH1*1.12838D0-H0TAB(IV)
C       HH3=(1.-H2TAB(IV))*.37613D0-HH1*.66667D0*VV+HH2*1.12838D0
C       HH4=(3.*HH3-HH1)*.37613D0+H0TAB(IV)*.66667D0*VV*VV
