...
C     ADDED THE FOLLOWING OPEN STATEMENTS
...
C 12345678901       123456            12345 1234567890                  1234567890
...
C     1 1.D7/DABS(DABS(EP)+ESHIFTP-DABS(E)+ESHIFT)+DWL+DWLISO
     1  1.D7/DABS(DABS(EP)+ESHIFTP-(DABS(E)+ESHIFT))+DWL+DWLISO
      ...
      IF(CODE.EQ.1.)LIM=1
C       IF(WLVAC.LT.WLBEG-DELLIM(LIM)*DELFACTOR)GO TO 900
...
C    unlog the shifted values
      ...
      WRITE(6,144)WLVAC,ALOG10(GF),CODE,E,XJ,LABEL,EP,XJP,LABELP,
     1 GR,GS,GW,REF
...
C     GR IS GAUNT FACTOR FOR CORONAL LINES
 ...
 1253 WRITE(19)WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,
     ...
     1     GAMMAR,GAMMAS,GAMMAW,NBUFF,LIM
      N19=N19+1
